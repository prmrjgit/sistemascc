...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
       ...
       $_SESSION['msg'] = "<p style='color: #f00;'>Evento agendado com sucesso!</p>";

    }
    
    else {
      $_SESSION['msg'] = "<p style='color: #f00;'>Erro ao agendar evento:!</p>";
...
<body>
  ...
  <div class="container">
    ...
    <!--        
            <h2 class="eventos-agendados">Eventos Recentes</h2>
